const gameModule = (() => {
  ...
  /**
   * Rotates and makes visible an svg line across the game board.  
   * @param {*} winCond A string win cond that gets generated by the checkCondition() method.
   */
  const drawLine = (winCond) => {
    ...
    // Rotates the line along the cartesian plane based on the x and y values of the two end points of the line. 
